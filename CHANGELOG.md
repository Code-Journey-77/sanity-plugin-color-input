...
- Updated `README.md` compatibility badges to reflect correct Sanity Studio (v3, v4, v5, v6) and Node.js (22, 24, 26) support.
- Updated `README.md` License section to explicitly reflect standard MIT License.
- Bumped version to explicitly invalidate package manager cache and ensure fresh TypeScript definitions.
